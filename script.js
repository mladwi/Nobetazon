...
const translations = {
    uz: {
        ...
        doseResult: "",
        nobetazon: "SHIFOKOR RESEPTISIZ BERILADI. QO'LLASHGA QARSHI KO'RSATMALAR MAVJUD. QO'LASHDAN OLDIN SHIFOKOR BILAN MASLAHATLASHING EKI YURIQNOMA BILAN TANISHING. MAHSULOT SERTIFIKATLANGAN. QAYD ETISH GUVOHNOMASI: DV/X 08953/05/21, DV/X 08954/05/21. ISHLAB CHIQARUVCHI: MCHJ NOBEL PHARMSANOAT CHEK, O'ZBEKISTON",
        Fn: "Yuz va boyin",
        Ah: "Qo'l va kaft",
        Lf: "Oyoq va tizza",
        Ac: "Kokrak va qorin",
    ...
    ru: {
        ...
        doseTitle: "Дозировка",
        doseResult: "",
        nobetazon: "ПРЕДПИСЫВАЕТСЯ ВРАЧОМ. ЕСТЬ ПРОТИВОПОКАЗАНИЯ. ПЕРЕД ПРИМЕНЕНИЕМ ПРОКОНСУЛЬТИРУЙТЕСЬ С ВРАЧОМ ИЛИ ОЗНАКОМЬТЕСЬ С ИНСТРУКЦИЕЙ. ПРОДУКТ СЕРТИФИЦИРОВАН. СВИДЕТЕЛЬСТВА О РЕГИСТРАЦИИ: DV/X 08953/05/21, DV/X 08954/05/21. ПРОИЗВОДИТЕЛЬ: ООО «НОБЕЛЬ ФАРМАЦЕЕВТИКА», УЗБЕКИСТАН.",
        Fn: "Лицо и шея",
        Ah: "Рука",
        Lf: "Нога и колена",
        Ac: "Грудь и Живот",
